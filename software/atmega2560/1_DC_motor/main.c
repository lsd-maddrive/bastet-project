...
void motor_go(uint8_t dir, uint8_t speed)
{
	...
	OCR2A = 255; //определяем скорость вращения
	OCR2B = 255; //определяем скорость вращения
	OCR4A = 255; //определяем скорость вращения
	OCR4C = 255; //определяем скорость вращения
