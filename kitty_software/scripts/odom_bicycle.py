...
OdomModel = KinematicBicycleModel(wheelbase=0.15,max_steer=45,delta_time=0.08)
x = 0
y = 0
yaw = 0
velocity = 1
...
steering_angle = 0.09
for i in range(500):
    x,y,yaw,velocity,steering_angle,angular_velocity = OdomModel.update(x,y,yaw,velocity,acceleration=0,steering_angle=steering_angle)
print(x,y)
